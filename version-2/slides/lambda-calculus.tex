...
\begin{frame}
  ...
  \infrule[E-App2]
         {\highlight[hlcol1]{t_2 \longrightarrow {t_2}^{\prime}}}
         {\highlight[hlcol1]{v_1~t_2 \longrightarrow v_1~{t_2}^{\prime}}}
  \infrule[E-AppLam]
          {}
          {\left(\lambda~x . t_{12}\right)~\highlight[hlcol1]{v_2} \longrightarrow \left[x \mapsto \highlight[hlcol1]{v_2} \right]~t_{12}}
  \end{mdframed}
\end{frame}
...
\begin{frame}
  ...
  \infrule[E-App1]
         {t_1 \longrightarrow {t_1}^{\prime}}
         {t_1~t_2 \longrightarrow {t_1}^{\prime}~t_2}
  \invisible{\infrule[E-App2]
         {t_2 \longrightarrow {t_2}^{\prime}}
         {v_1~t_2 \longrightarrow v_1~{t_2}^{\prime}}}
  \infrule[E-AppLam]
          {}
          {\left(\lambda~x . t_{12}\right)~\highlight[hlcol1]{t_2} \longrightarrow \left[x \mapsto \highlight[hlcol1]{t_2} \right]~t_{12}}
  \end{mdframed}
\end{frame}
