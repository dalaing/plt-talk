...
\begin{frame}
  ...
  \infrule[E-IsZeroSucc]
        {}
        {\text{iszero}~\left( \text{succ}~\highlight[hlcol1]{v} \right) \longrightarrow \text{false}}
  \end{mdframed}
  \medskip
\end{frame}
...
\begin{frame}
  ...
  \infrule[E-IsZeroSucc]
        {}
        {\text{iszero}~\left( \text{succ}~\highlight[hlcol1]{t} \right) \longrightarrow \text{false}}
  \end{mdframed}
  \medskip
\end{frame}
...
\begin{frame}
  ...
  \infrule[E-IsZeroSucc]
        {}
        {\text{iszero}~ \left( \text{succ}~\highlight[hlcol1]{nv} \right) \longrightarrow \text{false}}
  \end{mdframed}
\end{frame}
